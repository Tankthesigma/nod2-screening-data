...
Run this to create gpu0-gpu7 scripts with correct parameters.

FIXES APPLIED:
- Output paths match bash script (trajectories/, not ../trajectories/)
- modeller.deleteWater() before addSolvent (prevents water doubling)
- Hydrogen mass 3.0 amu (proper HMR for stable 4fs timestep)
"""
