#!/usr/bin/env python3
"""Create the PyMOL script for pathway diagram renders."""
...
# ============================================================================
# QUALITY SETTINGS (Maximum for 10K renders)
# ============================================================================
set antialias, 2
...
# Background = transparent for poster overlay
bg_color white
...
with open(r'C:\Users\vasud\nod2-screening-data\isef_figures\pathway_diagram\pathway_diagram_10K.pml', 'w') as f:
    f.write(content)
print('Created: pathway_diagram_10K.pml')
